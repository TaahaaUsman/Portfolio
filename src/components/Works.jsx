...
const Works = () => {
  return (
    <div id="projects">
      ...
      >
        The following projects are a small part of my skills and experiences
        through real examples of my work. Each project is briefly described with
